...
public class Config {
    ...
    public static final String CA_ORG1_URL = "http://" + HOST_IP + ":7054";

    public static final String CA_ORG2_URL = "http://" + HOST_IP + ":8054";

    public static final String ORDERER_URL = "grpc://" + HOST_IP + ":7050";
